export type PublicationMutationErrorCode =
  ...
  | "PUBLIC_VERIFICATION_INVALID"
  | "PUBLIC_VERIFICATION_VIDEO_MISMATCH"
  | "PUBLIC_VERIFICATION_PUBLICATION_ERROR"
  | "PUBLIC_VERIFICATION_CHANNEL_MISMATCH"
  | "PUBLIC_VERIFICATION_STATE_CONFLICT"
  | "PORTFOLIO_CHANNEL_OWNED"
  | "PORTFOLIO_OWNERSHIP_RELEASING"
  | "UNKNOWN";
