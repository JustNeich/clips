...
- В Step 3 `redactor_limited` с выданным channel access может загружать фон/музыку, импортировать backup шаблона в текущий draft и менять время публикации, но не меняет setup канала.
