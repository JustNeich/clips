...
const TARGETS = [
  {
    ...
    sourceFile: "public/ops/ghostface-country-avatar-v4.jpg",
    originalName: "ghostface-country-avatar-v4.jpg",
    referenceChannel: "Original Ghostface Country brand variant",
    referenceUrl: "generated://ghostface-country-v4"
  },
  {
    name: "GHOSTFACE WORKSHOP",
    username: "ghostfaceworkshop",
    sourceFile: "public/ops/ghostface-workshop-avatar-v4.jpg",
    originalName: "ghostface-workshop-avatar-v4.jpg",
    referenceChannel: "Original Ghostface Workshop brand variant",
    referenceUrl: "generated://ghostface-workshop-v4"
  }
] as const;
