...
export function ChannelManager({
  ...
  factoryStage2PromptConfig: factoryStage2PromptConfigProp,
  ...
  const [workspaceStage2ExamplesSourceMode, setWorkspaceStage2ExamplesSourceMode] =
    useState<Stage2ExamplesSourceMode>(
      findStage2SystemExamplesPresetByJson(workspaceStage2ExamplesCorpusJsonProp, workspaceStage2SystemExamplesPresets)
        ? "system"
        : "custom"
    );
  ...
  const factoryStage2PromptConfig = normalizeStage2PromptConfig(
    factoryStage2PromptConfigProp ?? workspaceStage2PromptConfigProp
  );
  ...
  const resetStage2PromptStage = (stageId: keyof Stage2PromptConfig["stages"]) => {
    setWorkspaceStage2PromptConfig((current) => ({
      ...
      stages: {
        ...current.stages,
        [stageId]: { ...factoryStage2PromptConfig.stages[stageId] }
      }
    }));
  };
  ...
  const updateWorkspaceExamplesSourceMode = (sourceMode: Stage2ExamplesSourceMode) => {
    ...
    if (sourceMode === "system") {
      const presetId =
        ...
        "system_examples";
      setWorkspaceStage2ExamplesCorpusJson(
        getStage2SystemExamplesPresetJson(presetId, workspaceStage2SystemExamplesPresets)
      );
    }
  };
  ...
  const updateChannelStage2PromptTemplate = (
    stageId: keyof Stage2PromptConfig["stages"],
    prompt: string
  ) => {
    setChannelStage2PromptConfig((current) => {
      const baseConfig = hasStage2PromptOverrides(current)
        ? current
        : workspaceStage2PromptConfig;
  ...
  const updateChannelStage2PromptReasoning = (
    stageId: keyof Stage2PromptConfig["stages"],
    reasoningEffort: Stage2PromptConfig["stages"][keyof Stage2PromptConfig["stages"]]["reasoningEffort"]
  ) => {
    setChannelStage2PromptConfig((current) => {
          ...
          <div className="channel-tab-content">
            ...
            {activeTab === "stage2" ? (
              <ChannelManagerStage2Tab
                ...
                channelStage2PromptConfig={channelStage2PromptConfig}
