...
3. Справа через inspector крутить radius, border, fill, shadow, font stacks, weights, colors и внутренние отступы.
   ...
   Для `Channel + Story` верхний и нижний внутренние отступы shell можно поднимать до 360px, чтобы вручную добавлять больше воздуха над channel row и под видео.
