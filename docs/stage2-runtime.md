...
- `storyOneShot` title options preserve the casing requested by `user_instruction`; unlike the classic path, story titles are not forced into ALL CAPS by runtime post-processing.
