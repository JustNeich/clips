...
- Multi-stage native flow, examples-routing, style discovery и editorial-memory steering больше не являются active runtime authority.
...
На уровне канала Stage 2 теперь редактируются только:
